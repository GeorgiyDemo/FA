class BinaryTree:
    ...
    def tree_string(self, root, curr_index, index=False, delimiter="-"):
        ...
        l_box, l_box_width, l_root_start, l_root_end = self.tree_string(
            root.left_child, 2 * curr_index + 1, index, delimiter
        )
        r_box, r_box_width, r_root_start, r_root_end = self.tree_string(
            root.right_child, 2 * curr_index + 2, index, delimiter
        )
