...
def main():
    ...
    for _ in range(n):
        d_args = {1: [fake.name(), fake.date()], 2: [fake.name(), fake.date(), get_way()],
                  3: [fake.name(), fake.date(), get_way(), random.randint(1, 4)],
                  4: [fake.name(), fake.date(), get_way(), get_job(), random.randint(5, 35)], }
