...
from airclass_module import AircraftClass, PlaneClass, HelicopterClass
from pvo_module import PVOClass, MissileClass, AntiAircraft
...
def main():
    ...
    if result == True:
        print("Мы уничтожили объект с названием '{}' и типом {}".format(killedobj_list[obj_number].name, killedobj_list[obj_number].type))
