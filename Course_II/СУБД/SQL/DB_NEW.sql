...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(38,39,'The Holy See (STATE_ of the Vatican City)','Holy See (Vatican City)','Southern Europe','Vatican City',0,0,19,'unnamed LOCATION_',75,'unnamed LOCATION_','11-Feb-1929','Coronation Day of Pope BENEDICT XVI','24-Apr',932,0.01,'','',0,'temperate; mild, rainy winters (September to May) with hot, dry summers (May to September)','VT','.va','EUR');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(688,9,'Tuvalu','','Oceania','Funafuti',26,24,0,'Pacific Ocean',5,'unnamed LOCATION_','1-Oct-1978','Independence Day','1-Oct',11810,1.51,68.32,24.6,1,'tropical; moderated by easterly trade winds (March to November); westerly gales and heavy rain (November to March)','TV','.tv','AUD');

INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(67,35,'Territory of Cocos (Keeling) Islands','Cocos (Keeling) Islands','Southeastern Asia','West Island',14,26,0,'Indian Ocean',5,'unnamed LOCATION_','','Australia Day','26-Jan',574,0,NULL,NULL,1,'tropical with high humidity, moderated by the southeast trade winds for about nine months of the year','CK','.cc','AUD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(686,9,'Republic of Kiribati','Kiribati','Oceania','Tarawa',811,1143,0,'Pacific Ocean',81,'unnamed LOCATION_','12-Jul-1979','Independence Day','12-Jul',105432,2.24,62.08,20.2,19,'tropical; marine, hot and humid, moderated by trade winds','KR','.ki','AUD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(12,9,'Coral Sea Islands Territory','Coral Sea Islands','Oceania',NULL,3,3095,0,'Pacific Ocean',6,'unnamed LOCATION_ on Cato Island',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'tropical','CR','','NONE');

INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(300,29,'Navassa Island','','Caribbean',NULL,5,8,0,'Caribbean Sea',77,'unnamed LOCATION_ on southwest side',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'marine, tropical','BQ','','NONE');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(2000,35,'Territory of Ashmore and Cartier Islands','Ashmore and Cartier Islands','Southeastern Asia',NULL,5,74,0,'Indian Ocean',3,'unnamed LOCATION_',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'tropical','AT','','NONE');

INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(208,35,'Spratly Islands','','Southeastern Asia',NULL,5,926,0,'South China Sea',4,'unnamed LOCATION_ on Southwest Cay',NULL,NULL,NULL,0,NULL,NULL,NULL,3,'tropical','PG','','NONE');

INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(207,35,'Paracel Islands','','Southeastern Asia',NULL,NULL,518,0,'South China Sea',14,'unnamed LOCATION_',NULL,NULL,NULL,0,NULL,NULL,NULL,0,'tropical','PF','','NONE');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(203,155,'Bailiwick of Jersey','Jersey','Western Europe','Saint Helier',116,70,0,'Atlantic Ocean',143,'unnamed LOCATION_','','Liberation Day','9-May',91084,0.28,79.38,41.4,1,'temperate; mild winters and cool summers','JE','.je','GBP');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(683,9,'Niue','','Oceania','Alofi',260,64,0,'Pacific Ocean',68,'unnamed LOCATION_','19-Oct-1974','Waitangi Day','6-Feb',2166,0.01,NULL,NULL,1,'tropical; modified by southeast trade winds','NE','.nu','NZD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(283,15,'Western Sahara','','Northern Africa','',266000,1110,-55,'Sebjet Tah',463,'unnamed LOCATION_',NULL,NULL,NULL,273008,NULL,NULL,NULL,11,'hot, dry desert; rain is rare; cold offshore air currents produce fog and heavy dew','WI','.eh','MAD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(260,18,'Republic of Zambia','Zambia','Southern Africa','Lusaka',752614,0,329,'Zambezi river',2301,'unnamed LOCATION_ in Mafinga Hills','24-Oct-1964','Independence Day','24-Oct',11502010,2.11,40.03,16.5,109,'tropical; modified by altitude; rainy season (October to April)','ZA','.zm','ZMK');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(690,9,'Tokelau','','Oceania','',10,101,0,'Pacific Ocean',5,'unnamed LOCATION_','','Waitangi Day','6-Feb',1392,-0.01,NULL,NULL,0,'tropical; moderated by trade winds (April to November)','TL','.tk','NZD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(15,18,'Europa Island','','Southern Africa','',28,22,0,'Indian Ocean',24,'unnamed LOCATION_',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'tropical','EU',NULL,'NONE');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(245,11,'Republic of Guinea-Bissau','Guinea-Bissau','Western Africa','Bissau',36120,350,0,'Atlantic Ocean',300,'unnamed LOCATION_','24-Sep-1973','Independence Day','24-Sep',1442029,2.07,46.87,19,28,'tropical; generally hot and humid; monsoonal-TYPE_ rainy season (June to November) with southwesterly winds; dry season (December to May) with northeasterly harmattan winds','PU','.gw','XOF');

INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(676,9,'Kingdom of Tonga','Tonga','Oceania','Nuku alofa',748,419,0,'Pacific Ocean',1033,'unnamed LOCATION_ on Kao Island','4-Jun-1970','Emancipation Day','4-Jun',114689,2.01,69.82,20.7,6,'tropical; modified by trade winds; warm season (December to May), cool season (May to December)','TN','.to','TOP');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(692,9,'Republic of the Marshall Islands','Marshall Islands','Oceania','Majuro',11854,370,0,'Pacific Ocean',10,'unnamed LOCATION_','1-Oct-1986','Constitution Day','1-May',60422,2.25,70.31,20.3,15,'tropical; hot and humid; wet season May to November; islands border typhoon belt','RM','.mh','USD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(1670,9,'Commonwealth of the Northern Mariana Islands','Northern Mariana Islands','Oceania','Saipan',477,1482,0,'Pacific Ocean',965,'unnamed LOCATION_ on Agrihan','','Commonwealth Day','8-Jan',82459,2.54,76.09,29.5,5,'tropical marine; moderated by northeast trade winds, little seasonal temperature variation; dry season December to June, rainy season July to October','CQ','.mp','USD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(205,18,'Juan de Nova Island','','Southern Africa',NULL,4,24,0,'Indian Ocean',10,'unnamed LOCATION_',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'tropical','JU',NULL,'NONE');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(22,155,'Bailiwick of Guernsey','Guernsey','Western Europe','Saint Peter Port',78,50,0,'Atlantic Ocean',114,'unnamed LOCATION_','','Liberation Day','9-May',65409,0.26,80.42,41.3,2,'temperate with mild winters and cool summers; about 50% of days are overcast','GK','.gg','GBP');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(220,11,'Republic of The Gambia','The Gambia','Western Africa','Banjul',11300,80,0,'Atlantic Ocean',53,'unnamed LOCATION_','18-Feb-1965','Independence Day','18-Feb',1641564,2.84,54.14,17.7,1,'tropical; hot, rainy season (June to November); cooler, dry season (November to May)','GA','.gm','GMD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(597,5,'Republic of Suriname','Suriname','South America','Paramaribo',163270,386,-2,'unnamed LOCATION_',1230,'Juliana Top','25-Nov-1975','Independence Day','25-Nov',439117,0.2,69.01,26.5,47,'tropical; moderated by trade winds','NS','.sr','SRD');

INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(674,9,'Republic of Nauru','Nauru','Oceania','no official capital',21,30,0,'Pacific Ocean',61,'unnamed LOCATION_','31-Jan-1968','Independence Day','31-Jan',13287,1.81,63.08,20.6,1,'tropical with a monsoonal pattern; rainy season (November to February)','NR','.nr','AUD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(960,34,'Republic of Maldives','Maldives','Southern Asia','Male',300,644,0,'Indian Ocean',2,'unnamed LOCATION_','26-Jul-1965','Independence Day','26-Jul',359008,2.78,64.41,17.9,5,'tropical; hot, humid; dry, northeast monsoon (November to March); rainy, southwest monsoon (June to August)','MV','.mv','MVR');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(685,9,'Independent STATE_ of Samoa','Samoa','Oceania','Apia',2944,403,0,'Pacific Ocean',1857,'Mauga Silisili','1-Jan-1962','Independence Day Celebration','1-Jun',176908,-0.2,71,25.2,4,'tropical; rainy season (November to April), dry season (May to October)','WS','.ws','SAT');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(965,145,'STATE_ of Kuwait','Kuwait','Middle East','Kuwait',17820,499,0,'Persian Gulf',306,'unnamed LOCATION_','19-Jun-1961','National Day','25-Feb',2418393,3.52,77.2,25.9,7,'dry desert; intensely hot summers; short, cool winters','KU','.kw','KD');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(974,145,'STATE_ of Qatar','Qatar','Middle East','Doha',11437,563,0,'Persian Gulf',103,'Qurayn Abu al Bawl','3-Sep-1971','Independence Day','3-Sep',885359,2.5,73.9,31.7,5,'arid; mild, pleasant winters; very hot, humid summers','QA','.qa','QAR');
...
INSERT INTO wf_countries (COUNTRY_ID,REGION_ID,COUNTRY_NAME,COUNTRY_TRANSLATED_NAME,LOCATION_,CAPITOL,AREA,COASTLINE,LOWEST_ELEVATION,LOWEST_ELEV_NAME,HIGHEST_ELEVATION,HIGHEST_ELEV_NAME,DATE_OF_INDEPENDENCE,NATIONAL_HOLIDAY_NAME,NATIONAL_HOLIDAY_DATE,POPULATION_,POPULATION_GROWTH_RATE,LIFE_EXPECT_AT_BIRTH,MEDIAN_AGE,AIRPORTS,CLIMATE,FIPS_ID,INTERNET_EXTENSION,CURRENCY_CODE)
VALUES(972,145,'STATE_ of Israel','Israel','Middle East','Jerusalem',20770,273,-408,'Dead Sea',1208,'Har Meron','14-May-1948','Independence Day','14-May',6352117,1.18,79.46,29.6,51,'temperate; hot and dry in southern and eastern desert areas','IS','.il','ILS');
...
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
VALUES(3,900,'QY','Qazaq, STATE_ language');
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
...
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
VALUES(230,460,'Y','official; spoken by less than 1% of the POPULATION_');
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
...
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
VALUES(677,460,'Y','English is official but spoken by only 1%-2% of the POPULATION_  Note: 120 indigenous languages');
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
...
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
VALUES(94,1770,'Y','note: English is commonly used in government and is spoken competently by about 10% of the POPULATION_');
INSERT INTO wf_spoken_languages(country_id,language_id,official,comments)
...
CREATE TABLE  F_CUSTOMERS
   (ID NUMBER(5,0),
    ...
    ADDRESS_ VARCHAR2(50) CONSTRAINT F_CSRS_ADDRESS_NN NOT NULL ENABLE,
    CITY VARCHAR2(30) CONSTRAINT F_CSR_CITY_NN NOT NULL ENABLE,
    STATE_ VARCHAR2(20) CONSTRAINT F_CSR_STATE_NN NOT NULL ENABLE,
...
CREATE TABLE  F_PROMOTIONAL_MENUS
   (CODE VARCHAR2(3),
    NAME_ VARCHAR2(30) CONSTRAINT F_PMU_NAME_NN NOT NULL ENABLE,
    START_DATE_ DATE CONSTRAINT F_PMU_START_DATE_NN NOT NULL ENABLE,
    END_DATE DATE,
...
CREATE TABLE  F_REGULAR_MENUS
   (CODE VARCHAR2(3),
    TYPE_ VARCHAR2(30) CONSTRAINT F_RMU_TYPE_NN NOT NULL ENABLE,
...
CREATE TABLE  F_FOOD_ITEMS
   (FOOD_ITEM_NUMBER NUMBER(5,0),
    DESCRIPTION_ VARCHAR2(100) CONSTRAINT F_FIM_DESC_NN NOT NULL ENABLE,
...
CREATE TABLE  F_SHIFTS
   (CODE NUMBER(5,0),
    DESCRIPTION_ VARCHAR2(100) CONSTRAINT F_SFT_DESC_NN NOT NULL ENABLE,
...
INSERT INTO f_customers(id,first_name,last_name,ADDRESS_,city,STATE_,zip,phone_number)
...
INSERT INTO f_promotional_menus(code,NAME_,START_DATE_,end_date,give_away)
...
INSERT INTO f_regular_menus(code,TYPE_,hours_served)
VALUES('10','Breakfast','6-11am');
INSERT INTO f_regular_menus(code,TYPE_,hours_served)
VALUES('20','Lunch/Dinner','11-9pm');
--Populate f_food_items table
INSERT INTO f_food_items(food_item_number,DESCRIPTION_,price,regular_code,promo_code)
...
INSERT INTO f_shifts(code,DESCRIPTION_)
...
CREATE TABLE  D_THEMES
   (CODE NUMBER(10,0),
    DESCRIPTION_ VARCHAR2(100) CONSTRAINT D_TME_DESC_NN NOT NULL ENABLE,
...
CREATE TABLE  D_VENUES
   (ID NUMBER(5,0),
    ...
    ADDRESS_ VARCHAR2(100) CONSTRAINT D_VNE_ADDRESS_NN NOT NULL ENABLE,
...
CREATE TABLE  D_EVENTS
   (ID NUMBER(5,0),
    NAME_ VARCHAR2(50) CONSTRAINT D_EVE_NAME_NN NOT NULL ENABLE,
...
CREATE TABLE  D_TYPES
   (CODE NUMBER(10,0),
    DESCRIPTION_ VARCHAR2(50) CONSTRAINT D_TPE_DESC_NN NOT NULL ENABLE,
...
INSERT INTO d_themes(code,DESCRIPTION_)
VALUES(200,'Tropical');
INSERT INTO d_themes(code,DESCRIPTION_)
VALUES(220,'Carnival');
INSERT INTO d_themes(code,DESCRIPTION_)
...
INSERT INTO d_venues(id,loc_type,ADDRESS_,rental_fee,comments)
...
INSERT INTO d_events(client_number,id,NAME_,event_date,DESCRIPTION_,cost,venue_id,package_code,theme_code)
...
INSERT INTO d_types(code,DESCRIPTION_)
VALUES(1,'Jazz');
INSERT INTO d_types(code,DESCRIPTION_)
VALUES(12,'Pop');
INSERT INTO d_types(code,DESCRIPTION_)
...
CREATE TABLE  JOB_HISTORY
   (EMPLOYEE_ID NUMBER(6,0) CONSTRAINT JHIST_EMPLOYEE_NN NOT NULL ENABLE,
    START_DATE_ DATE CONSTRAINT JHIST_START_DATE_NN NOT NULL ENABLE,
    END_DATE DATE CONSTRAINT JHIST_END_DATE_NN NOT NULL ENABLE,
    JOB_ID VARCHAR2(10) CONSTRAINT JHIST_JOB_NN NOT NULL ENABLE,
    DEPARTMENT_ID NUMBER(4,0),
     CONSTRAINT JHIST_DATE_INTERVAL CHECK (end_date > START_DATE_) ENABLE,
     CONSTRAINT JHIST_EMP_ID_ST_DATE_PK PRIMARY KEY (EMPLOYEE_ID, START_DATE_)
  USING INDEX  ENABLE
   );
...
INSERT INTO job_history(employee_id,START_DATE_,end_date,job_id,department_id)
