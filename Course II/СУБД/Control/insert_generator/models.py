...
class House(SQLModel):
    """Дом"""
    @validate_arguments
    def __init__(self, id : int, name : str, price : float, ac : int, tv : int, safe : int, description : str = None, type_: str = None, booking_id: int = None) -> None:
        self.id = id
        self.name = name
        self.price = price
        self.ac = ac
    ...
    def insert(self) -> str:
        ...
        return f"INSERT INTO houses (id, name, price, ac, tv, safe, description, type, booking_id)\
            VALUES ({self.id},'{self.name}',{self.price},{self.ac},{self.tv},{self.safe},{description},{type_},{booking_id})"

class Client(SQLModel):
    """Клиент"""
    @validate_arguments
    def __init__(self, id : int, first_name : str, last_name : str, email : str, phone : str, document_title : str, document_file : str, document_text : str, document_comments : str = None, special_requests : str = None) -> None:
        self.id = id
...
class Order(SQLModel):
    """Заказ"""
    @validate_arguments
    def __init__(self, id : int, order_date: datetime.datetime, client_id : int, cost : float = None) -> None:
        self.id = id
