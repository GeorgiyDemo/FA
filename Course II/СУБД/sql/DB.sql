...
ALTER TABLE academic_session ADD CONSTRAINT academic_session_pk PRIMARY KEY ( id );
...
ALTER TABLE course
    ADD CONSTRAINT arc_1 CHECK ( ( ( online_logon_id IS NOT NULL )
                                   AND ( SEATED_DateTime IS NULL )
                                   AND ( seated_building IS NULL )
                                   AND ( seated_room IS NULL ) )
                                 OR ( ( SEATED_DateTime IS NOT NULL )
                                      AND ( seated_building IS NOT NULL )
                                      AND ( seated_room IS NOT NULL )
                                      AND ( online_logon_id IS NULL ) ) );
...
ALTER TABLE exam_result
    ADD CONSTRAINT exam_result_pk PRIMARY KEY ( course_id,
                                                exam_id,
                                                id );
...
ALTER TABLE exam_type ADD CONSTRAINT exam_type_pk PRIMARY KEY ( type );
...
ALTER TABLE faculty_course_detail ADD CONSTRAINT faculty_course_detail_pk PRIMARY KEY ( course_id,
                                                                                        faculty_id );
...
ALTER TABLE faculty_login_detail ADD CONSTRAINT faculty_login_detail_pk PRIMARY KEY ( faculty_id );
...
ALTER TABLE full_time ADD CONSTRAINT full_time_pk PRIMARY KEY ( id );
...
ALTER TABLE "ONLINE" ADD CONSTRAINT online_pk PRIMARY KEY ( logon_id );
...
ALTER TABLE parent_information ADD CONSTRAINT parent_information_pk PRIMARY KEY ( id );
...
ALTER TABLE part_time ADD CONSTRAINT part_time_pk PRIMARY KEY ( id );
...
ALTER TABLE seated
    ADD CONSTRAINT seated_pk PRIMARY KEY ( "DateTime",
                                           building,
                                           room );
...
ALTER TABLE student_course_detail ADD CONSTRAINT student_course_detail_pk PRIMARY KEY ( course_id,
                                                                                        id );

ALTER TABLE course
    ADD CONSTRAINT course_academic_session_fk FOREIGN KEY ( academic_session_id )
...
ALTER TABLE course
    ADD CONSTRAINT course_online_fk FOREIGN KEY ( online_logon_id )
        REFERENCES "ONLINE" ( logon_id );

ALTER TABLE course
    ADD CONSTRAINT course_seated_fk FOREIGN KEY ( SEATED_DateTime,
                                                  seated_building,
                                                  seated_room )
        REFERENCES seated ( "DateTime",
                            building,
                            room );
