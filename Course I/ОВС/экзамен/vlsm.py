...
def printTable(table, majorNet, neededHosts, allocatedHosts):
    ...
    print(
        ...
        Fore.BLACK,
        Style.NORMAL,
        " Доступные сети в основной сети:",
        Fore.WHITE,
        Back.GREEN,
        Style.BRIGHT,
        "{}".format(ipTemp.size),
    ...
    print(
        ...
        Fore.BLACK,
        Style.NORMAL,
        " IP-адреса в подсетях:",
        Fore.WHITE,
        Back.GREEN,
        Style.BRIGHT,
        "{}".format(allocatedHosts),
        Style.RESET_ALL,
    )
    print("\n")
    print(table)
...
def requestNets(netSize):
    ...
    for i in range(netSize):
        buf_list.append(
            int(input("Введите кол-во хостов в подсети №" + str(i + 1) + " -> ")) + 2
        )
        ...
        for pos in range(0, netSize):
            ...
            table.add_row(
                [
                    ...
                    ip.size - 2,
                    ip.ip,
                    "{} - {}".format(ip_list[1], ip[len(ip_list) - 2]),
                    ip.broadcast,
                    "/{}".format(ip.prefixlen),
                    ip.netmask,
                ]
