...
def main():
    ...
    for _ in range(n):
        r_int = randint(1, 4)
        d_args = {1: (fake.word(), [randint(1, 100), randint(1, 100)]),2: (fake.word(), [randint(1, 100), randint(1, 100)], randint(1, 1000), randint(50, 300), randint(1000, 6000)),3: (fake.word(), [randint(1, 100), randint(1, 100)], randint(1, 1000), randint(1960, 2020)),: (fake.word(), [randint(1, 100), randint(1, 100)], randint(1, 1000), randint(50, 300), fake.word()),}
