...
def main():
    ...
    for _ in range(n):
        r_int = randint(1, 4)
        d_args = {1: (fake.name(), fake.date(pattern='%d.%m.%Y'), randint(1, 1000000), randint(0, 100)),2: (fake.name(), fake.date(pattern='%d.%m.%Y'), randint(1, 1000000), randint(0, 100)),3: (fake.name(), fake.date(pattern='%d.%m.%Y'), randint(1, 1000000), randint(0, 100), randint(1, 1000000)),4: (fake.word(), fake.date(pattern='%d.%m.%Y'), randint(1000000, 9999999), randint(1, 1000000)),}
